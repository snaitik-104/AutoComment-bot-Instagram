...
def login_to_instagram(browser):
    ...
    browser.implicitly_wait(5)
     ...
     # //*[@id="loginForm"]/div/div[3]/button/div[1]
    browser.find_element(By.XPATH,"/html/body/div[1]/div/div/div/div[1]/div/div/div/div[1]/section/main/article/div[2]/div[1]/div[2]/form/div/div[3]").click() 
    ...
    for hashtag in database['hashtags']:
        ...
        for post in range(1,database['number_of_posts']):
                ...
                try:
                    # browser.find_element(By.CLASS_NAME,'_aagw').click()
                    browser.implicitly_wait(10)
                    browser.find_element(By.XPATH,"/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[2]/div/div/div[2]/section[3]/div/form/textarea").click()
                    ...
                    if do_i_comment == 1:
                        ...
                        browser.implicitly_wait(10)
                        comment = browser.find_element( By.XPATH,"/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[2]/div/div/div[2]/section[3]/div/form/textarea")
                        ...
                        logger.info(post)
                        if(post==1):
                              browser.find_element(By.XPATH,'/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[1]/div/div/div/button').click()
                              logger.info('Getting next post')
                              sleep(randint(database['wait_between_posts']
                              ['min'], database['wait_between_posts']['max']))

                        else:
                             browser.find_element(By.XPATH,'/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[1]/div/div/div[2]/button').click()
                             logger.info('Getting next post')
                             sleep(randint(database['wait_between_posts']
                              ['min'], database['wait_between_posts']['max']))
